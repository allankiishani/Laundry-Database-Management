...
// Fetch the entire laundry history for the logged-in student
$sql = "SELECT * FROM YourTableName WHERE RegistrationNo = '$registrationNumber' ORDER BY TaskID DESC";
...
<head>
    <title>My Laundry History | Sparkle Spins Laundry Service</title>
    <style>
        body {
            display: flex;
